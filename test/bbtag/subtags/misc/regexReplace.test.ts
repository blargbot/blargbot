    ...
    cases: [
        {
            ...
            expected: '',
            assert(ctx) {
                assert.deepEqual(ctx.data.replace, { regex: /[a-z]\d/g, with: 'oooh' });
            }
        },
        {
        ...
        },
        {
            ...
            expected: '',
            assert(ctx) {
                assert.deepEqual(ctx.data.replace, { regex: , with: 'oooh' });
            },
            errors: [
