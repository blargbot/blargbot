    ...
    cases: [
        {
            ...
            expected: '',
            assert(ctx) {
                expect(ctx.state.replace).to.deep.equal({ regex: /[a-z]\d/g, with: 'oooh' });
            }
        },
        {
        ...
        },
        {
            ...
            expected: '',
            assert(ctx) {
                expect(ctx.state.replace).to.deep.equal({ regex: , with: 'oooh' });
            },
            errors: [
