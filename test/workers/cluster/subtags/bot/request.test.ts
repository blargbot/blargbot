    ...
    cases: [
        {
            ...
            setup(ctx) {
                ctx.managers.domain.setup(m => m.isWhitelisted('httpbin.org')).thenReturn(true);
            },
            assert(_, result) {
        ...
        },
        {
            ...
            setup(ctx) {
                ctx.managers.domain.setup(m => m.isWhitelisted('cdn.discordapp.com')).thenReturn(true);
            },
            assert(_, result) {
                const response = JSON.parse(result) as JObject;
                expect(response).to.deep.equal({
        ...
        },
        {
            ...
            setup(ctx) {
                ctx.managers.domain.setup(m => m.isWhitelisted('test.com')).thenReturn(false);
            }
        },
        {
