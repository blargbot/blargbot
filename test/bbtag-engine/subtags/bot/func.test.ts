...
import { bbtag, BBTagRuntimeState, replacers, SubtagStackOverflowError, UnknownSubtagError } from '@blargbot/bbtag-engine';

import { AssertSubtag, runSubtagTests } from '../SubtagTestSuite.js';

await runSubtagTests({
    replacer: replacers.functionInvokeReplacer,
