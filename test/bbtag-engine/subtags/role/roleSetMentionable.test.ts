            ...
            cases: [
                {
                    ...
                    postSetup(role, _, ctx) {
                        ctx.discord.setup(m => m.editRole(ctx.guild.id, role.id, $.looksLike({ mentionable: true }), 'Command User#0000'))
                            .thenResolve(role);
                    }
                }
            ]
            ...
            cases: [
                {
                    expected: '',
                    postSetup(role, _, ctx) {
                        ctx.discord.setup(m => m.editRole(ctx.guild.id, role.id, $.looksLike({ mentionable: false }), 'Command User#0000'))
                            .thenResolve(role);
                    }
                }
            ]
