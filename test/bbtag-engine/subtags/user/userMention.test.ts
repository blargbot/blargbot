    ...
    cases: [
        ...
        },
        {
            ...
            postSetup(bbctx, ctx) {
                ...
                otherMember.setup(m => m.user, false).returns(otherUser.instance);
                otherUser.setup(m => m.id).returns('098765434512212678');
                otherUser.setup(m => m.mention).returns('<@098765434512212678>');
