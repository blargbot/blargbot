...
await runSubtagTests({
    replacer: replacers.waitMessageReplacer,
    ...
    cases: [
        {
            ...
            setup(ctx) {
                ...
                ctx.util.setup(m => m.awaitMessage($.looksLike([ctx.channels.command.id]), anyCondition.value, 60000))
        ...
        },
        {
            ...
            postSetup(bbctx, ctx) {
                const acceptedMessage = createFilterableMessage(ctx, bbctx.guild, '3982746234283749322', ctx.channels.command.id);
                const rejectedMessage = createRejectedMessage(ctx, '23897464293623984274432');
                ctx.util.setup(m => m.awaitMessage($.looksLike(['21938762934928374']), anyCondition.value, 60000))
                    .thenCall(createFakeAwaiterFactory(acceptedMessage.instance, [rejectedMessage.instance]));

                const channel = ctx.createMock(eris.TextChannel);
                channel.setup(m => m.id).returns('21938762934928374');
        ...
        },
        {
            ...
            postSetup(bbctx, ctx) {
                ...
                const rejectedMessage = createRejectedMessage(ctx, '23897464293623984274432');
                ctx.util.setup(m => m.awaitMessage($.looksLike(['21938762934928374', '987234657348965', '39457643897564358']), anyCondition.value, 60000))
                    .thenCall(createFakeAwaiterFactory(acceptedMessage.instance, [rejectedMessage.instance]));

                const channel1 = ctx.createMock(eris.TextChannel);
                channel1.setup(m => m.id).returns('21938762934928374');
                ...
                channel2.setup(m => m.id).returns('987234657348965');
                ...
                channel3.setup(m => m.id).returns('39457643897564358');
        ...
        },
        {
            ...
            postSetup(bbctx, ctx) {
                ...
                user.setup(m => m.id).returns('289374634729826479828');
        ...
        },
        {
            ...
            postSetup(bbctx, ctx) {
                ...
                user1.setup(m => m.id).returns('289374634729826479828');
                ctx.util.setup(m => m.getUser('289374634729826479828')).thenResolve(undefined);
                ...
                user2.setup(m => m.id).returns('328762389764234374');
                ...
                user3.setup(m => m.id).returns('23894767278934620893');
        ...
        },
        {
            ...
            postSetup(bbctx, ctx) {
                ...
                const filterableMessage = createFilterableMessage(ctx, bbctx.guild, '5847658249242834983', ctx.channels.command.id, '289374634729826479828');
                const rejectedMessage = createRejectedMessage(ctx);
                ctx.util.setup(m => m.awaitMessage($.looksLike(['21938762934928374']), anyCondition.value, 10000))
                    .thenCall(createFakeAwaiterFactory(acceptedMessage.instance, [filterableMessage.instance, rejectedMessage.instance]));
        ...
        },
        {
            ...
            postSetup(bbctx, ctx) {
                ...
                const filterableMessage = createFilterableMessage(ctx, bbctx.guild, '5847658249242834983', ctx.channels.command.id, '289374634729826479828');
                const rejectedMessage = createRejectedMessage(ctx);
                ctx.util.setup(m => m.awaitMessage($.looksLike(['21938762934928374']), anyCondition.value, 0))
                    .thenCall(createFakeAwaiterFactory(acceptedMessage.instance, [filterableMessage.instance, rejectedMessage.instance]));
        ...
        },
        {
            ...
            postSetup(bbctx, ctx) {
                ...
                const filterableMessage = createFilterableMessage(ctx, bbctx.guild, '5847658249242834983', ctx.channels.command.id, '289374634729826479828');
                const rejectedMessage = createRejectedMessage(ctx);
                ctx.util.setup(m => m.awaitMessage($.looksLike(['21938762934928374']), anyCondition.value, 300000))
                    .thenCall(createFakeAwaiterFactory(acceptedMessage.instance, [filterableMessage.instance, rejectedMessage.instance]));
