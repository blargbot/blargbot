import { BBTagRuntimeError, ChannelNotFoundError, MessageNotFoundError, replacers, UserNotFoundError } from '@blargbot/bbtag-engine';
import * as eris from 'eris';

import { runSubtagTests, SubtagTestContext } from '../SubtagTestSuite.js';

await runSubtagTests({
    replacer: replacers.reactionRemoveReplacer,
