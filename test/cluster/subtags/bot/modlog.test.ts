    ...
    cases: [
        {
            ...
            postSetup(bbctx, ctx) {
                ...
                ctx.managers.modlog.setup(m => m.logCustom(bbctx.guild, 'poke', user.instance, bbctx.user, '', undefined)).thenResolve(undefined);
            }
        },
        {
            ...
            postSetup(bbctx, ctx) {
                ...
                ctx.managers.modlog.setup(m => m.logCustom(bbctx.guild, 'poke', user1.instance, user2.instance, '', undefined)).thenResolve(undefined);
            }
        },
        {
            ...
            postSetup(bbctx, ctx) {
                ...
                ctx.util.setup(m => m.findMembers(bbctx.guild, '023634983746234834')).thenResolve([member1.instance]);
                ctx.util.setup(m => m.findMembers(bbctx.guild, '2365432687945234625')).thenResolve([member2.instance]);
                ctx.managers.modlog.setup(m => m.logCustom(bbctx.guild, 'poke', user1.instance, user2.instance, 'power abuse is fun', undefined)).thenResolve(undefined);
            }
        },
        {
            ...
            postSetup(bbctx, ctx) {
                ...
                ctx.util.setup(m => m.findMembers(bbctx.guild, '023634983746234834')).thenResolve([member1.instance]);
                ctx.util.setup(m => m.findMembers(bbctx.guild, '2365432687945234625')).thenResolve([member2.instance]);
                ctx.managers.modlog.setup(m => m.logCustom(bbctx.guild, 'poke', user1.instance, user2.instance, 'power abuse is fun', 0xff0000)).thenResolve(undefined);
            }
        },
        {
            code: '{modlog;poke;023634983746234834;;;}',
