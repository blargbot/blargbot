...
import { SpliceSubtag } from '@blargbot/cluster/subtags/array/splice';
...
runSubtagTests({
    ...
    cases: [
        ...
        },
        {
            ...
            assert(_, __, ctx) {
                expect(ctx.tagVariables[`${SubtagVariableType.LOCAL}.testTag.arr1`]).to.deep.equal([1, 2, 4, 5, 6]);
            }
        },
        {
            ...
            assert(_, __, ctx) {
                expect(ctx.tagVariables[`${SubtagVariableType.LOCAL}.testTag.arr1`]).to.deep.equal([1, 5, 6]);
            }
        },
        {
        ...
        },
        {
            ...
            assert(_, __, ctx) {
                expect(ctx.tagVariables[`${SubtagVariableType.LOCAL}.testTag.arr1`]).to.deep.equal([1, 2, 'a', 3, 4, 5, 6]);
            }
        },
        {
            ...
            assert(_, __, ctx) {
                expect(ctx.tagVariables[`${SubtagVariableType.LOCAL}.testTag.arr1`]).to.deep.equal([1, 2, 'a', 4, 5, 6]);
            }
        },
        {
            ...
            assert(_, __, ctx) {
                expect(ctx.tagVariables[`${SubtagVariableType.LOCAL}.testTag.arr1`]).to.deep.equal([1, 2, 'a', 'b', 'c', 'd', 'e', 'f', 5, 6]);
            }
        },
        {
            ...
            assert(_, __, ctx) {
                expect(ctx.tagVariables[`${SubtagVariableType.LOCAL}.testTag.arr1`]).to.deep.equal([1, 2, 'a', '1', '2', 'd', 'e', 'f', 5, 6]);
            }
        },
        {
            code: '{splice;arr1;2;2;a;[1,2,"d"];e;f}',
        ...
        },
        {
            ...
            setup(ctx) {
                ctx.options.tagName = 'testTag';
                ctx.tagVariables[`${SubtagVariableType.LOCAL}.testTag.arr1`] = 'abc';
            }
        },
        {
