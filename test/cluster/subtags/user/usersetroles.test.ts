import { BBTagRuntimeError, NotAnArrayError, RoleNotFoundError } from '@blargbot/cluster/bbtag/errors';
import { UserSetRolesSubtag } from '@blargbot/cluster/subtags/user/usersetroles';
