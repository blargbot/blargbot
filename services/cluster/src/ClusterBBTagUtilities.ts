// import type { AwaitReactionsResponse, BBTagContext, BBTagSendContent, BBTagUtilities, Entities } from '@blargbot/bbtag';
...
export class ClusterBBTagUtilities /*implements BBTagUtilities*/ {
    ...
    //     public awaitMessage(channels: string[], filter: (message: Entities.Message) => Awaitable<boolean>, timeoutMs: number): Promise<Entities.Message | undefined> {
