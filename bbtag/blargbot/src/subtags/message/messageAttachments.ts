            ...
            definition: [
                {
                    ...
                    returns: 'string[]',
                    execute: (ctx) => this.getMessageAttachments(ctx, ctx.runtime.channel.id, ctx.runtime.message.id, false)
                },
                {
                    ...
                    returns: 'string[]',
                    execute: (ctx, [messageId]) => this.getMessageAttachments(ctx, ctx.runtime.channel.id, messageId.value, false)
                },
                {
