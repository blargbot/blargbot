...
import { BBTagRuntimeError, ChannelNotFoundError, MessageNotFoundError, UserNotFoundError } from '@bbtag/engine';

export class ReactionRemoveSubtag extends Subtag {
    public constructor() {
        super({
            name: 'reactionRemove',
