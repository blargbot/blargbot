...
import { EscapeBBTagSubtag, IndexOfSubtag } from '@bbtag/blargbot/subtags';

import { runSubtagTests } from '../SubtagTestSuite.js';

runSubtagTests({
    subtag: IndexOfSubtag,
    ...
    cases: [
        ...
        { code: '{indexof;{escapebbtag;{"n":"abc","v":["a"]}};a}', expected: '0', subtags: [EscapeBBTagSubtag] }
    ]
});
