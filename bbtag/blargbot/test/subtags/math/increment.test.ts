...
runSubtagTests({
    ...
    cases: [
        ...
        },
        {
            ...
            assert(_, __, ctx) {
                chai.expect(ctx.tagVariables.get({ scope: { ownerId: BigInt(ctx.guild.id), scope: 'public:tag' }, name: 'myVariable' })).to.equal(25);
            }
        },
        {
            code: '{increment;_myVariable;3}',
        ...
        },
        {
            ...
            assert(_, __, ctx) {
                chai.expect(ctx.tagVariables.get({ scope: { ownerId: BigInt(ctx.guild.id), scope: 'public:tag' }, name: 'myVariable' })).to.equal(25.1);
            }
        },
        {
            ...
            assert(_, __, ctx) {
                chai.expect(ctx.tagVariables.get({ scope: { ownerId: BigInt(ctx.guild.id), scope: 'public:tag' }, name: 'myVariable' })).to.equal(25.6);
            }
        },
        {
