    ...
    cases: [
        {
            ...
            postSetup(bbctx, ctx) {
                ctx.inject.messages.setup(m => m.delete(bbctx.runtime, ctx.channels.command.id, ctx.message.id)).thenResolve();
            }
        },
        {
        ...
        },
        {
            ...
            postSetup(bbctx, ctx) {
                ...
                ctx.inject.messages.setup(m => m.delete(bbctx.runtime, ctx.channels.command.id, '1234567890123456')).thenResolve();
            }
        },
        {
        ...
        },
        {
            ...
            postSetup(bbctx, ctx) {
                ctx.inject.messages.setup(m => m.get(bbctx.runtime, bbctx.runtime.channel.id, '1234567890123456')).thenResolve(undefined);
            },
            errors: [
        ...
        },
        {
            ...
            postSetup(bbctx, ctx) {
                ...
                ctx.inject.channels.setup(m => m.querySingle(bbctx.runtime, '987654322123456142')).thenResolve(channel);
                ctx.inject.messages.setup(m => m.get(bbctx.runtime, channel.id, message.id)).thenResolve(message);
                ctx.inject.messages.setup(m => m.delete(bbctx.runtime, channel.id, '1234567890123456')).thenResolve();
            }
        },
        {
            ...
            postSetup(bbctx, ctx) {
                ctx.inject.channels.setup(m => m.querySingle(bbctx.runtime, '987654322123456142')).thenResolve(undefined);
            },
            errors: [
