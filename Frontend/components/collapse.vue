            ...
            for (const key in this.collapseData) {
                ...
                for (const index in filtered) {
                    ...
                    if (subtag.active) {
                        ...
                        $(body).slideUp();
                        this.$set(this.collapseData[key], this.collapseData[key].indexOf(subtag), subtag)
                    }
                }
            }
        },
            ...
            for (const key in this.collapseData) {
                ...
                for (const index in filtered) {
                    ...
                    if (!element.active) {
                        ...
                        $(body).slideDown();
                        this.$set(this.collapseData[key], this.collapseData[key].indexOf(element), element)
                    }
                }
            }
        },
