...
export async function getBBTagDocsEmbed(context: CommandContext, topic: string | undefined): Promise<EmbedOptions | string | undefined> {
...
const variablesScopes = [
    ...
    },
    {
        name: 'Local',
        prefix: '',
        description: 'Local variables are the default variable type, only usable if your variable name doesn\'t start with one of the other prefixes. ' +
