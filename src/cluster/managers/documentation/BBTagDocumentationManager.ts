        ...
        return {
            ...
            items: [
                ...
                },
                {
                    ...
                    tags: [`variables`],
                    embed: {
                        description: `In BBTag there are ${tagVariableScopeProviders.length} different scopes that can be used for storing your data. These scopes are determined by the first character of your variable name, so choose carefully!`
                    },
                ...
                },
                {
                    ...
                    pages: [
                        ...
                        },
                        {
                            ...
                            value: `Example:\`\`\`\n[arg]\`\`\`Optional arguments may or may not be provided. If supplied, optional arguments may either change the functionality of the tag (e.g. \`b!${this.#commandName} docs shuffle\`) or simply replace a default value (e.g. \`b!${this.#commandName} docs username\`).\n\u200B`
                        },
                        {
                            name: `Multiple arguments ...`,
                            value: `Example:\`\`\`\n<arg...>\`\`\`Some arguments can accept multiple values, meaning you are able to list additional values, still separated by \`;\`, which will be included in the execution. (e.g. \`b!${this.#commandName} docs randchoose\`)`
                        },
                        {
                            name: `Nested arguments <<> <>>`,
                            value: `Example:\`\`\`\n<<arg1>, [arg2]>\`\`\`Some subtags may have special rules for how their arguments are grouped (e.g. \`b!${this.#commandName} docs switch\`) and will use nested arguments to show that grouping. When actually calling the subtag, you provide the arguments as normal, however you must obey the grouping rules.\nIn the example of \`switch\`, you may optionally supply \`<case>\` and \`<then>\` as many times as you like but they must always be in pairs. e.g. \`{switch;value;case1;then1}\` or \`{switch;value;case1;then1;case2;then2}\` etc`
                        }
                    ].map(x => ({
                        name: x.name,
                        type: `leaf`,
                ...
                },
                {
                    ...
                    pages: [
                        ...
                        {
                            name: `Variable`,
                            value: `A variable is a value that is stored in the bots memory ready to access it later on. For more in-depth details about variables, please use \`b!${this.#commandName} docs variable\`.`
                        },
                        {
                            name: `Array`,
