            ...
            definition: [
                {
                    ...
                    description: `Accepts 1 or more boolean \`values\` (\`true\` or \`false\`) and returns the result of \`operator\` on them. Valid logic operators are \`${[...Object.keys(bbtag.logicOperators), '^'].join('`, `')}\`.See \`{operators}\` for a shorter way of performing logic operations.`,
