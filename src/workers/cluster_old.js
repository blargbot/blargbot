...
global.bbtag = require('../core/bbtag.js');
...
class DiscordClient extends Client {
    constructor() {
        ...
        this.models = {};
        this.database = new PostgresDb(this);
        ...
        const CommandManagerClass = require('../core/CommandManager.js');
