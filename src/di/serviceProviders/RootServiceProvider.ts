...
export class ServiceProvider implements IServiceProvider {
    ...
    public getService<T>(type: Type<T>): T {
        return new ResolutionServiceProvider(this, this.#resolvers, this.#rootScope, undefined).getService(type);
    }

    public getServices<T>(type: Type<T>): Iterable<T> {
        return new ResolutionServiceProvider(this, this.#resolvers, this.#rootScope, undefined).getServices(type);
    }
