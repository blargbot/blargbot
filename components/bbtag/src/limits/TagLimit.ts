...
export class TagLimit extends GlobalLimit {
    public constructor(guild?: Entities.Guild) {
        ...
        this.addRules('ban', disabledRule)
            ...
            .addRules('foreach:loops', new UseCountRule((guild?.approximate_member_count ?? 0) + 100000, textTemplates.limits.rules.useCount.loops, () => new TooManyLoopsError(100000)))
            .addRules('map:loops', new UseCountRule((guild?.approximate_member_count ?? 0) + 100000, textTemplates.limits.rules.useCount.loops, () => new TooManyLoopsError(100000)))
