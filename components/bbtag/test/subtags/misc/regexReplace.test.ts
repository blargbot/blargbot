    ...
    cases: [
        {
            ...
            expected: '',
            assert(ctx) {
                chai.expect(ctx.data.replace).to.deep.equal({ regex: /[a-z]\d/g, with: 'oooh' });
            }
        },
        {
        ...
        },
        {
            ...
            expected: '',
            assert(ctx) {
                chai.expect(ctx.data.replace).to.deep.equal({ regex: , with: 'oooh' });
            },
            errors: [
