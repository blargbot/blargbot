...
export function parseDuration(text: string, fallbackMs: moment.Duration): moment.Duration;
export function parseDuration(text: string, fallbackMs?: moment.Duration): moment.Duration | undefined;
export function parseDuration(text: string, fallbackMs?: moment.Duration): moment.Duration | undefined {
    const ctx = { text };
    const durations = [
